...
public:
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "GirlsToken - Debug window", nullptr));
        label_9->setText(QApplication::translate("RPCConsole", "GirlsToken Core", nullptr));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the GirlsToken debug log file from the current data directory. This can take a few seconds for large log files.", nullptr));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the GirlsToken-Qt help message to get a list with possible GirlsToken command-line options.", nullptr));
#endif // QT_NO_TOOLTIP
